...
For a comprehensive overview of the system architecture, design decisions, and technical details, see **[ARCHITECTURE.md](ARCHITECTURE.md)**.

### Quick Overview

**VEHICLE-LAB** follows a layered architecture:

* **Presentation Layer**: Web client with interactive Plotly visualizations
* **Application Layer**: Flask REST API with modular blueprints
* **Business Logic Layer**: DiagAI system and 12+ analysis modules
* **Data Processing Layer**: asammdf, pandas, numpy, scipy for data manipulation
* **Data Persistence Layer**: DuckDB (time-series), Supabase (metadata), ChromaDB (RAG)

**Key Architectural Features:**
* Multi-LLM support with smart routing (DeepSeek, LM Studio, Ollama, Trained Models)
* OEM-specific RAG systems with complete data isolation
* 9 specialized diagnostic agents working in coordination
* Memory-mapped I/O for handling large files (up to 1GB)
* Intelligent signal alias resolution (155 patterns, 1,817+ signals)
...
* **🏗️ [System Architecture](ARCHITECTURE.md)** - Complete system architecture and design
